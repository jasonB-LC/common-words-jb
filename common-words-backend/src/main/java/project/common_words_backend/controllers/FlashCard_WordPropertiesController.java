...
@RestController
@RequestMapping("/flash-card-word-properties")
public class FlashCard_WordPropertiesController {
    ...
    @GetMapping("")
    public ResponseEntity<?> getAllFCWP() {
    ...
    public ResponseEntity<?> addNewFCWP(@RequestBody FlashCard_WordPropertiesDTO flashCard_WordPropertiesDTO){
